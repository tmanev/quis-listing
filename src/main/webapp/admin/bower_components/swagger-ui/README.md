...
### SwaggerUi
To use swagger-ui you should take a look at the [source of swagger-ui html qlPage](https://github.com/swagger-api/swagger-ui/blob/master/dist/index.html) and customize it. This basically requires you to instantiate a SwaggerUi object and call load() on it as below:
